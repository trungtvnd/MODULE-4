...
import com.codegym.rest.JWTAtuthenticationTokenFilter;
...
public class SecurityConfig  extends WebSecurityConfigurerAdapter {
    @Bean
    public JWTAtuthenticationTokenFilter jwtAuthenticationTokenFilter() {
        return new JWTAtuthenticationTokenFilter();
    }
